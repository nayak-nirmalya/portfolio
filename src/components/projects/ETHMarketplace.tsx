...
const ETHMarketplace = () => {
  return (
    <div className="projects__card">
      ...
      <p>
        It's a DApp where user can purchase courses from available courses in
        Marketplace. Also an admin is a superuser who can verify, activate and
        deactivate any users' course.
      </p>
