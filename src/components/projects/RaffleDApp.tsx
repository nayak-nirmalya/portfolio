...
const RaffleDApp = () => {
  return (
    <div className="projects__card">
      ...
      <p>
        It&apos;s a DApp where multiple user can enter a raffle with pre defined Entrance Fee. After
        a time interval a random user is pciked as winner and gets all Ethers of the contract.
      </p>
